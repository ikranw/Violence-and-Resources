function renderElectricityBarChart(data, parentElement) {
  ...
  const valueKey = "Share of the population with access to electricity";
  ...
  svg.selectAll('.bar')
    ...
    .attr('height', d => height - yScale(d[valueKey]));
}